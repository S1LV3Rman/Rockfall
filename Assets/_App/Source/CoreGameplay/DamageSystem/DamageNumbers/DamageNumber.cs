...
namespace S1LV3Rman.RockFall.CoreGameplay
{
    public class DamageNumber : AliveTrackedUIBehaviour, IReusableInPool
    {
        ...
        public void Show(Vector3 startPosition, int damageAmount,
            float horizontalDeviation, float lifetime, float size, float sizeDecrease, Color color,
        ...
        private void LateUpdate()
        {
            ...
            _text.fontSize = Mathf.Lerp(_initialSize, _initialSize * _sizeDecrease, normalizedLifetime);
        }
