...
namespace S1LV3Rman.RockFall.CoreGameplay
{
    ...
    {
        [field: SerializeField] public Indicator IndicatorPrefab { get; private set; }
        [field: SerializeField] public TargetIndicator TargetIndicatorPrefab { get; private set; }
